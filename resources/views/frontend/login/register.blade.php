...
=======
                <div class="c2city">
                    <a href="javascript:;" class="choose-city" baidu_alog="pc_index_city&mouseenter&pc_index_city_change_h">  <span>北京 <i>&nbsp;</i> </span>  </a> 
                    <i class="maskline"></i>
                    <div class="city-box">
                        <div class="all-city">
                               ...
                               <dl>
                                <dt>周边</dt>
                                <dd>    
                                     <a data-gzlog='tracking_type=click&eventid=0020060000000018&select_city=tj' baidu_alog='pc_index_city&click&pc_index_around_city_c' href='/tj/' title='天津'>天津</a><a data-gzlog='tracking_type=click&eventid=0020060000000018&select_city=tangshan' baidu_alog='pc_index_city&click&pc_index_around_city_c' href='/tangshan/' title='唐山'>唐山</a><a data-gzlog='tracking_type=click&eventid=0020060000000018&select_city=sjz' baidu_alog='pc_index_city&click&pc_index_around_city_c' href='/sjz/' title='石家庄'>石家庄</a><a data-gzlog='tracking_type=click&eventid=0020060000000018&select_city=qinhuangdao' baidu_alog='pc_index_city&click&pc_index_around_city_c' href='/qinhuangdao/' title='秦皇岛'>秦皇岛</a><a data-gzlog='tracking_type=click&eventid=0020060000000018&select_city=xingtai' baidu_alog='pc_index_city&click&pc_index_around_city_c' href='/xingtai/' title='邢台'>邢台</a><a data-gzlog='tracking_type=click&eventid=0020060000000018&select_city=chengde' baidu_alog='pc_index_city&click&pc_index_around_city_c' href='/chengde/' title='承德'>承德</a><a data-gzlog='tracking_type=click&eventid=0020060000000018&select_city=hengshui' baidu_alog='pc_index_city&click&pc_index_around_city_c' href='/hengshui/' title='衡水'>衡水</a><a data-gzlog='tracking_type=click&eventid=0020060000000018&select_city=langfang' baidu_alog='pc_index_city&click&pc_index_around_city_c' href='/langfang/' title='廊坊'>廊坊</a>                                    </dd>
                                </dl>
                                <dl>
                                <dt>热门</dt>
                                <dd>
                            ...
                            <div class="city-line"></div>
                                    ...
                                    <dd>
                                                                                    ...
                                                                                    <a  data-gzlog="tracking_type=click&eventid=0020060000000017&select_city=dongying" baidu_alog="pc_index_city&click&pc_index_all_city_c"
                                                                                                    href="/dongying/"
                                                                                                title="东营"                                                >东营                                            </a>
                                                                                    <a  data-gzlog="tracking_type=click&eventid=0020060000000017&select_city=dandong" baidu_alog="pc_index_city&click&pc_index_all_city_c"
                                                                                                    href="/dandong/"
                                                                                                title="丹东"                                                >丹东                                            </a>
                                    ...
                                    <dd>
                                                                                    <a  data-gzlog="tracking_type=click&eventid=0020060000000017&select_city=eerduosi" baidu_alog="pc_index_city&click&pc_index_all_city_c"
                                                                                                    href="/eerduosi/"
                                                                                                title="鄂尔多斯"                                                >鄂尔多斯                                            </a>
                                                                                    <a  data-gzlog="tracking_type=click&eventid=0020060000000017&select_city=ezhou" baidu_alog="pc_index_city&click&pc_index_all_city_c"
                                                                                                    href="/ezhou/"
                                                                                                title="鄂州"                                                >鄂州                                            </a>
                                                                            </dd>
                                </dl>
...
<<<<<<< HEAD
                    <button class="search-btn" data-gzlog="" baidu_alog='' style=' float:right;'>搜索</button>
=======
...
<<<<<<< HEAD
                <a class="fr "  href="#"  title="分期付款">分期乐</a>
                <a class="fl active"  href="#"  title="校园">首页</a>
                <a class="fl " href="#"  title="北京个人"> 我要shop物</a>
                <a class="fl " href="#" title="北京出售" >我要sale物</a>
                <a class="fl " href="#"  title="校园服务保障">服务保障</a>

                <a class="fl " href="#"  title="校园问答系统">问答</a>
=======
...
<<<<<<< HEAD
          ...
          <div id="tab-pannel-1">
            <form model-node="normal_form" method="POST" action="" id="ajax_register_form">
...
<<<<<<< HEAD
                    <input event-node="uname" status="0" name="uname" id="username" autocomplete="off" value="" class="s-txt" type="text">
                    <span id="s_name"></span>
=======
...
<<<<<<< HEAD
                  <input event-node="email" event-args="" id="email" name="email"  autocomplete="off" class="s-txt" type="text">
...
<<<<<<< HEAD
                  ...
                  <input name="sex" class="s-radio" value="1" checked="checked" event-node="radio" event-args="error=请选择性别" type="radio">男</label>　
                  <label>
                  <input event-node="radio" name="sex" value="0" class="s-radio" type="radio">女</label>
