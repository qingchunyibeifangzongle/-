...
<div >
    ...
    <div class="ibox-content">
        <form class="form-horizontal m-t"onsubmit="return checksubmit()" action="{{URL('admin/userAddPost')}}" method="post" >
            <div class="form-group">
                <label class="col-sm-3 control-label">用户名：</label>
                <div class="col-sm-8">
                    <input id="username" name="username" class="form-control" type="text" placeholder="用户名为英文">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="password" name="password" class="form-control" type="password" placeholder="密码为字母数字">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input id="name" name="name" class="form-control" type="text" placeholder="真实姓名为中文">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <input id="email" name="email" class="form-control" type="email" placeholder="邮箱必须含有@">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input class="form-control layer-date" id="create_time" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" type="text" name="create_time">
